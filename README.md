...
|  `rotateImage180`            |                   | bool           | Read / write | -       |   -           |  No             | Flag for enabling rotating the image 180 degrees                                      |  Parameter introduced mainly for r1, since in the latest updates the camera is mounted upside down |
